...
def register():
    ...
    Label(register_screen, text="Name", font=('Calibri',12)).grid(row=1,sticky=W,padx=10)
    Label(register_screen, text="Age", font=('Calibri',12)).grid(row=2,sticky=W,padx=10)
    Label(register_screen, text="Gender", font=('Calibri',12)).grid(row=3,sticky=W,padx=10)
    Label(register_screen, text="Password", font=('Calibri',12)).grid(row=4,sticky=W,padx=10)
